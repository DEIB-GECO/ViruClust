           ...
           <v-card-text>
             <v-layout row wrap justify-center style="padding: 30px;">
              <v-flex class="no-horizontal-padding xs12 d-flex" style="justify-content: center; margin-top: 10px">
               ...
               <v-flex class="no-horizontal-padding xs12 md5 d-flex" style="justify-content: center;">
           ...
           <v-card-text>
             <v-layout row wrap justify-center style="padding: 30px;">
               ...
               <v-flex class="no-horizontal-padding xs12 d-flex" style="justify-content: center; margin-top: 80px">
                 <h2 style="text-align: center">CHANGES IN TARGET vs BACKGROUND LOCATION</h2><h2 v-if="rowsTableProvReg.length > 1">S</h2>
               </v-flex>
              ...
              slider-size="6">
                ...
                <v-tab style="border-bottom: black solid 1px; width: 150px" v-for="(rows ,index) in rowsTableProvReg" v-bind:key="index">
                ...
                <v-tabs-items v-model="selectedTabTable" style="background: #F1FAEE;">
                  <v-tab-item style="padding: 20px; background-color: #F1FAEE" v-for="(rows ,index) in rowsTableProvReg" v-bind:key="index">
                     <v-layout row wrap justify-space-around style="margin-top: 10px">
                       ...
                       <v-flex class="no-horizontal-padding xs12 d-flex" style="justify-content: center">
                          <h2>TABLE<v-btn @click="downloadTable('table_prov_reg', rows)" x-small icon
...
export default {
  ...
  methods: {
    ...
    downloadExampleCSV(){
      let text = "";
      let result_sorted = [{'Protein': 'Spike', 'Description': 'Receptor-binding Domain (RBD)', 'Begin': 319, 'End': 541},
                           {'Protein': 'Spike', 'Description': 'Receptor-binding Motif (RBM)', 'Begin': 438, 'End': 506},
                           {'Protein': 'M', 'Description': 'Whole protein', 'Begin': 1, 'End': 222},
                           {'Protein': 'E', 'Description': 'Whole protein', 'Begin': 1, 'End': 75},
                           {'Protein': 'N', 'Description': 'Whole protein', 'Begin': 1, 'End': 419},
                           {'Protein': 'ORF10', 'Description': 'Whole protein', 'Begin': 1, 'End': 38},
                           {'Protein': "NSP16", 'Description': 'Whole protein', 'Begin': 1, 'End': 298},
                           {'Protein': 'NSP3', 'Description': 'Whole protein', 'Begin': 1, 'End': 1945},
                           {'Protein': 'NSP4', 'Description': 'Whole protein', 'Begin': 1, 'End': 500},
                           {'Protein': 'NSP15', 'Description': 'Whole protein', 'Begin': 1, 'End': 346},
                           {'Protein': 'NSP5', 'Description': 'Whole protein', 'Begin': 1, 'End': 306},
                           {'Protein': "NSP14", 'Description': 'Whole protein', 'Begin': 1, 'End': 527},
                           {'Protein': 'NSP11', 'Description': 'Whole protein', 'Begin': 1, 'End': 13},
                           {'Protein': 'NSP13', 'Description': 'Whole protein', 'Begin': 1, 'End': 601},
                           ...
                           {'Protein': 'NSP12', 'Description': 'Whole protein', 'Begin': 1, 'End': 932},
                           {'Protein': 'ORF1ab', 'Description': 'Whole protein', 'Begin': 1, 'End': 7096},
                           {'Protein': 'NSP10', 'Description': 'Whole protein', 'Begin': 1, 'End': 138},
                           {'Protein': 'NSP1', 'Description': 'Whole protein', 'Begin': 1, 'End': 180},
                           {'Protein': 'ORF1a', 'Description': 'Whole protein', 'Begin': 1, 'End': 4405},
                           {'Protein': 'NSP2', 'Description': 'Whole protein', 'Begin': 1, 'End': 638},
                           {'Protein': 'NS3', 'Description': 'Whole protein', 'Begin': 1, 'End': 275},
                           {'Protein': 'NS6', 'Description': 'Whole protein', 'Begin': 1, 'End': 61},
                           {'Protein': 'NS7a', 'Description': 'Whole protein', 'Begin': 1, 'End': 121},
                           {'Protein': 'NS7b', 'Description': 'Whole protein', 'Begin': 1, 'End': 43},
                           {'Protein': 'NS8', 'Description': 'Whole protein', 'Begin': 1, 'End': 121},
      ];
    ...
    modifyPossibleBackground() {
      ...
      if (this.queryGeo['province']) {
        ...
        let location ;
        if(this.queryGeo['province'].length > 1){
          location = "( ";
          for(let j = 0; j < this.queryGeo['province'].length; j = j + 1){
            location = location + this.queryGeo['province'][j];
            if(j < this.queryGeo['province'].length - 1){
              location = location + ' , ';
            }
          }
          location = location + ' )';
          ...
          location = this.queryGeo['province'];
        }

        let possibleBackground1 = {'value': 1,
          'background': location + ' vs ' + this.queryGeo['region'] }
        let possibleBackground2 = {'value': 2,
          'background': location + ' vs ' + this.queryGeo['country'] }
        let possibleBackground3 = {'value': 3,
          'background': location + ' vs ' + this.queryGeo['geo_group'] }
        let possibleBackground4 = {'value': 4,
          'background': location + ' vs ' + 'World' }
        ...
        let location ;
        if(this.queryGeo['region'].length > 1){
          location = "( ";
          for(let j = 0; j < this.queryGeo['region'].length; j = j + 1){
            location = location + this.queryGeo['region'][j];
            if(j < this.queryGeo['region'].length - 1){
              location = location + ' , ';
            }
          }
          location = location + ' )';
        ...
        let location ;
        if(this.queryGeo['country'].length > 1){
          location = "( ";
          for(let j = 0; j < this.queryGeo['country'].length; j = j + 1){
            location = location + this.queryGeo['country'][j];
            if(j < this.queryGeo['country'].length - 1){
              location = location + ' , ';
            }
          }
          location = location + ' )';
          ...
          location = this.queryGeo['country'];
        }
        ...
        let location ;
        if(this.queryGeo['geo_group'].length > 1){
          location = "( ";
          for(let j = 0; j < this.queryGeo['geo_group'].length; j = j + 1){
            location = location + this.queryGeo['geo_group'][j];
            if(j < this.queryGeo['geo_group'].length - 1){
              location = location + ' , ';
            }
          }
          location = location + ' )';
          ...
          location = this.queryGeo['geo_group'];
        }
